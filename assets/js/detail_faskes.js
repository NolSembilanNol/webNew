document.addEventListener('DOMContentLoaded', function() {
        ...
        .then(data => {
            ...
            data.forEach(markerInfo => {
                ...
                marker.bindPopup(`
                    ...
                    <button onclick="showRoute(${markerInfo.lat}, ${markerInfo.lng}, ${markerInfo.id})">Kunjungi</button>
                `);
                ...
                // Tambahkan ID dari database ke marker sebagai properti
                marker.dbId = markerInfo.id;
            });
        })
        .catch(error => {
    ...
    window.showRoute = function(destinationLat, destinationLng, id) {
        ...
        // Kirim ID bersamaan dengan lat dan lng ke halaman detail
        window.location.href = "detail.php?id=" + id + '&lat=' + destinationLat + '&lng=' + destinationLng;
    };
});